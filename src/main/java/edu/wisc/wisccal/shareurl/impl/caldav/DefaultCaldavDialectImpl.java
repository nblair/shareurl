...
public class DefaultCaldavDialectImpl implements CaldavDialect{
	...
	/**
	 * {@link ProdId} attached to {@link Calendar}s sent to the CalDAV server by ShareURL.
	 */
	protected static final ProdId PROD_ID = new ProdId("-//wisc.edu//WiscCal ShareURL 2.0//EN");
	...
	public String getCalendarAccountHome(ICalendarAccount calendarAccount) {
		...
		final String accountUsername = calendarAccount.getCalendarUniqueId();
