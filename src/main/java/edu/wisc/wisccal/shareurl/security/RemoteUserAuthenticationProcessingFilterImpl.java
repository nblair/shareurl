...
/**
 * Pubcookie processing filter.
 * You need to add pubcookie protection around the url:
 * 
 * web application context + "/security_check"
 * 
 * Where web application context is the location of your app ("cal" by default).
 * 
 * @author Nicholas Blair, nblair@doit.wisc.edu
 * @version $Id: PubcookieProcessingFilterImpl.java 1441 2009-12-17 19:09:21Z npblair $
 */
