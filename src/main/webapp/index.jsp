...
<div id="briefdescr">
<p>ShareURL is an enhancement for WiscCal that allows you to create a unique <abbr title="Uniform Resource Locator; a web address">URL</abbr> that allows you and anyone else to view your WiscCal event data.</p>
</div>

<p>
Once you create your ShareURL, it can be used to retrieve your WiscCal event data in a number of different formats:</p>
<ul>
<li><abbr title="Internet Standard for Calendar data exchange - RFC 5545">iCalendar</abbr>, used by many Desktop Calendar clients and Google Calendar</li>
<li>HTML, view your Calendar in a web browser</li>
<li><abbr title="Really Simple Syndication">RSS</abbr>, subscribe to your calendar in a News Reader like any other feed</li>
<li><abbr title="JavaScript Object Notation">JSON</abbr>, the data format for the web and web developers</li>
</ul>
...
<a class="login" href="<c:url value="/delegate-login.html"/>">Log in to Manage ShareURLs for a WiscCal <abbr title="Conference Room, Projector, etc.">Resource</abbr>&nbsp;&#187;</a>
</div>


<p>Your ShareURL can provide a read-only link to all your WiscCal calendar data. <strong>If you have ANY sensitive data (e.g., personal, financial, 
medical information, or <a href="https://kb.wisc.edu/helpdesk/page.php?id=24155">data marked private that you do not wish to share</a>), then you should use caution with this feature.</strong></p>
